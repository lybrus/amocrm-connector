...
интеграции появляются ошибки. Цель данного проекта помочь создать надежный, протестированный инструмент для работы с amocrm.
...
Спасибо за помощь в тестировании! Если у вас есть пожелания, также открывайте issue!

## Разработка

Помощь в разработке приветствуется! Если у вас есть вопросы касательно разработки - пишите мне в телеграм [@lybrus](https://t.me/lybrys).
...
Для удобства можно воспользоваться шаблоном `.evnt.test.example` (здесь также описано для чего нужны переменные)
```shell
